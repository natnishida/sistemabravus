...
@section('content')
<div class="container">
      <form action="/novo-sistema-bravus/public/atualizacao_freepass/{{ $freepass -> id_freepass }}" method="POST">
                  {!! csrf_field() !!}
          <div class="d-flex flex-column justify-content-center mb-3">
            ...
            <div class="form-group control-label row align-items-center">
              ...
              <input type="text" readonly class="form-control col-4 p-0" id="inputIdFreePass" name="inputIdFreePass" value="{{ $freepass -> id_prospect }}" style="text-align: center">
            </div>
            <div class="form-group control-label row align-items-center">
            <p style="text-align: left" class="col-2 m-0">Nome:</p>
            <input type="text" readonly class="form-control col-10 p-0" id="inputNomeFreePass" name="inputNomeFreePass" value="{{ $freepass -> nome_prospect }}" style="text-align: center">
            </div>
            @else
            ...
            @endisset
            <div class="form-group control-label row align-items-center">
            <p style="text-align: left" class="col-2 m-0">Consultora responsável pela atualização:</p>
          ...
          <div class="form-row">
            <div class="form-group col-md-2 mt-1">
              ...
              <input class="m-0" type="date" id="inputDataFreePass" name="inputDataFreePass" value="{{ $freepass->data_freepass }}">
            </div>
            <div class="form-group col-md-1 mt-1">
              <label for="inputHoraFreePass">Hora</label>
              <input class="m-0" type="time" id="inputHoraFreePass" name="inputHoraFreePass" value="{{ $freepass->hora_freepass }}">
            </div>
              <div class="form-group col-md-3">
                ...
                <select class="custom-select mr-sm-2" name="inputModalidadeFreePass" id="inputModalidadeFreePass">
                  <option value="{{$freepass->nome_modalidade}}" selected> {{ $freepass->nome_modalidade }}</option>
              ...
              <div class="form-group col-md-3">
                ...
                <select class="custom-select mr-sm-2" name="inputAnamneseFreePass" id="inputAnamneseFreePass">
                  <option selected value="{{$freepass->anamnese_feita_freepass}}">{{$freepass->anamnese_feita_freepass}}</option>
              ...
              <div class="form-group col-md-3">
                ...
                <select class="custom-select mr-sm-2" name="inputStatusFreePass" id="inputStatusFreePass">
                  <option selected value="{{$freepass->status_freepass}}">{{$freepass->status_freepass}}</option>
          ...
          <div  class="form-row">
            ...
            <textarea rows="8" cols="80" class="form-control" id="inputNegociacaoFreePass" name="inputNegociacaoFreePass"  placeholder="Insira qualquer dado de negociação que tenha sido passado."
            >{{$freepass->detalhes_negociacao_freepass}}</textarea>
            </div>
          </div>
